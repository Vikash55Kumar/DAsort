...
const HomePage: React.FC = () => {
  const features = [
    {
      ...
      description:
        'Semantic search to match job descriptions accurately with NCO codes, even when keywords differ.',
      icon: MagnifyingGlassIcon,
    },
    {
      name: 'Detailed Analytics',
      description:
        'Real-time reports on classification accuracy, processing time, and data coverage.',
      icon: ChartBarIcon,
    },
    {
      name: 'Automated Validation',
      description:
        'Detects anomalies and inconsistencies in job classification automatically.',
      icon: DocumentCheckIcon,
    },
    {
      name: 'Faster Processing',
      description:
        'Reduces classification time from hours to seconds while maintaining quality.',
      icon: ClockIcon,
    },
    {
      name: 'Role-Based Access',
      description:
        'Different permissions for enumerators, analysts, and administrators.',
      icon: UsersIcon,
    },
    {
      name: 'Secure Infrastructure',
      description:
        'Government-grade encryption and secure storage of sensitive survey data.',
      icon: ShieldCheckIcon,
    },
  ];
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-[#ecf0f3]">
        <div className="max-w-7xl mx-auto">
          <div className="pb-10 lg:max-w-2xl lg:w-full lg:pb-16">
            <main className="mt-8 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-14 lg:mt-20 lg:px-8">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-3xl tracking-tight font-bold text-[#00295d] sm:text-4xl md:text-5xl">
                  AI-Enabled NCO Classification Portal
                </h1>
                <p className="mt-4 text-base text-gray-700 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-6 md:text-lg lg:mx-0">
                  An official platform to automate and improve job classification
                  for National Surveys under NCO-2015. Built to reduce manual
                  errors, increase accuracy, and speed up survey data collection.
                </p>
                <div className="mt-6 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div>
                    <Link to="/register">
                      <Button
                        size="lg"
                        className="w-full px-8 py-3 bg-[#00295d] text-white hover:bg-blue-900"
                      >
                        Get Started
                      </Button>
                    </Link>
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <Link to="/about">
                      <Button
                        variant="outline"
                        size="lg"
                        className="w-full px-8 py-3 border-[#00295d] text-[#00295d] hover:bg-[#ecf0f3]"
                      >
                        Learn More
                      </Button>
                    </Link>
      ...
      <div className="py-14 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-sm text-[#00295d] font-semibold tracking-wide uppercase">
              The Challenge
            </h2>
            <p className="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl">
              Issues with Current Job Classification
            </p>
            <p className="mt-4 max-w-2xl text-lg text-gray-600 lg:mx-auto">
              The current process depends on manual keyword matching in static
              NCO documents, causing delays, inconsistencies, and errors.
            </p>
          </div>
            ...
            {[
              {
                name: 'Time-Consuming Process',
                description:
                  'Manually scanning 3,600+ occupation codes is slow and requires trained personnel.',
              },
              {
                name: 'Error-Prone Results',
                description:
                  'Exact keyword dependency leads to misclassification and poor data quality.',
              },
              {
                name: 'Poor Scalability',
                description:
                  'Manual workflows cannot handle the scale of national-level surveys.',
              },
              {
                name: 'Training Overhead',
                description:
                  'Enumerators require extensive familiarity with the occupation taxonomy.',
              },
            ].map((item) => (
              <div key={item.name} className="relative pl-14">
                <div className="absolute left-0 flex items-center justify-center h-10 w-10 rounded-full bg-red-600 text-white text-sm font-bold">
                  !
                </div>
      ...
      {/* Features Section */}
      <div className="py-14 bg-[#ecf0f3] border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-sm text-[#00295d] font-semibold tracking-wide uppercase">
              Our Solution
            ...
            <p className="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl">
              AI-Powered Government Tool
            </p>
            <p className="mt-4 max-w-2xl text-lg text-gray-600 lg:mx-auto">
              This platform uses advanced AI to automate and standardize job
              classification, ensuring consistency, speed, and accuracy across
              all government surveys.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-14">
                <div className="absolute left-0 flex items-center justify-center h-12 w-12 rounded-md bg-[#00295d] text-white">
                  <feature.icon className="h-6 w-6" aria-hidden="true" />
                </div>
      ...
      {/* CTA Section */}
      <div className="bg-[#00295d]">
        <div className="max-w-2xl mx-auto text-center py-14 px-4 sm:py-16 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">
            Ready to Modernize Your Data Collection?
          </h2>
          <p className="mt-3 text-base text-blue-100">
            Join the AI-powered initiative for faster, more accurate government
            surveys.
          </p>
          <Link to="/register">
            <Button
              variant="secondary"
              size="lg"
              className="mt-6 bg-white text-[#00295d] hover:bg-gray-100"
            >
              Get Started
            </Button>
          </Link>
